...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetPath + 'js/scripts/newpage/json/accesos.json', // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $role = full['role'];
            var roleBadgeObj = {
              Cliente: feather.icons['user'].toSvg({ class: 'font-medium-3 text-primary me-50' }),
      ...
      buttons: [
        {
          extend: 'collection',
          className: 'd-none btn btn-outline-secondary dropdown-toggle me-2',
        ...
        {
          text: 'Add New User',
          className: 'd-none add-new btn btn-primary',
          attr: {
